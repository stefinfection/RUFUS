...
for CONTROL in "${CONTROL_BAM_LIST[@]}"; do
    ...
    bcftools mpileup -d600 -T $NORMED_VCF -f $REFERENCE_FILE $CONTROL_BAM | bcftools call -cv -Oz -o $CONTROL_VCF 
    ...
    cp $OUTFILE "${OUT_DIR}/${OUT_VCF}" 
    cp $OUT_INDEX "${OUT_DIR}/${OUT_VCF}.tbi" 
