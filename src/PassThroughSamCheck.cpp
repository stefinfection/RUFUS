...
/* I think this takes in a sam file, pulls out the necessary fields, and pipes it out. It doesn't seem to be
"checking" anything in particular. I'm guessing this exists to ensure that the hand-written perl script to 
create a sam from a fastq file worked correctly, and also to accomodate some sort of parallelism associated
with chromosomes, but haven't seen any in code yet. */
