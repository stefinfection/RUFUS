...
if [ "$REGION" == "wg" ]; then
    ...
    aws s3 cp --no-sign-request "s3://rufus.marth.lab/public_access_data/${HASH_TYPE}_hashes/${HASH_VERSION}/${chrom}/${FMTD_REG}_${HASH_TYPE}_${HASH_VERSION}.Jhash" "/mnt/rufus_resources/${FMTD_REG}_${HASH_TYPE}_${HASH_VERSION}.Jhash"
fi